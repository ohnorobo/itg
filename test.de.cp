...
dadurch könnte eine heikle situation umso gefährlicher werden .
...
( die sitzung wird um <num> uhr geschlossen . )
wiederaufnahme der sitzungsperiode
- ' es reicht ' .
im jahr <num> gewann ¡ basta ya !
gibt es einwände ?
vorbehaltlich dieser bemerkung wird das protokoll genehmigt .
die folgende änderung wurde beantragt :
mittwoch :
...
nein , dies ist kein punkt für das plenum .
...
der handel ist natürlich wichtig .
